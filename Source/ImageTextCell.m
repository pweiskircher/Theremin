...
- (void)drawWithFrame:(NSRect)cellFrame inView:(NSView *)controlView {
	...
	float x = cellFrame.origin.x + 5;
	if (icon)
		x += cellFrame.size.height + 10;
	...
	[primaryText drawAtPoint:NSMakePoint(x, cellFrame.origin.y) withAttributes:primaryTextAttributes];
	...
	[secondaryText drawAtPoint:NSMakePoint(x, cellFrame.origin.y+cellFrame.size.height/2) 
