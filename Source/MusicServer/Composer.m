...
NSString *gUnknownComposerName = @"gUnknownComposerName";
...
- (NSString *) description {
	return [NSString stringWithFormat:@"Composer <%p> Name: %@ SQLIdentifier: %d", self, [self name], [self identifier]];
}
...
- (void) setName:(NSString *)aName {
	...
	if ([aName isEqualToString:gUnknownComposerName])
		mName = [TR_S_UNKNOWN_COMPOSER retain];
	else
		mName = [aName retain];
}
