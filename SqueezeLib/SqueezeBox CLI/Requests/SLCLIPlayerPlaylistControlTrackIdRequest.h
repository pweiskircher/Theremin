...
typedef enum {
	SLCliPlayerPlaylistControlModeAdd,
	SLCliPlayerPlaylistControlModeRemove
} SLCliPlayerPlaylistControlMode;

@class SLPlayer;

@interface SLCLIPlayerPlaylistControlTrackIdRequest : SLCLIPlayerRequest {
	SLCliPlayerPlaylistControlMode _mode;
	NSIndexSet *_trackIds;
}
