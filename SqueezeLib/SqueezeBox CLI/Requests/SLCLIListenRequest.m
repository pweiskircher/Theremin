...
@implementation SLCLIListenRequest
+ (id) listenRequest {
	return [[[SLCLIListenRequest alloc] init] autorelease];
}

- (id) init {
	self = [super initWithCommand:@"subscribe pause,playlist,stop,play,prefset"];
	return self;
}
